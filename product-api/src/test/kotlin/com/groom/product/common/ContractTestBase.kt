...
@SqlGroup(
    Sql(scripts = ["/sql/init-product-query-controller.sql"], executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD),
    Sql(scripts = ["/sql/cleanup-product-query-controller.sql"], executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD),
)
